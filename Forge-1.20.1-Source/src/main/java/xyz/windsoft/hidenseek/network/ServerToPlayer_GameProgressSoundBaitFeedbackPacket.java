 ...
 * - This packet is created by the Server and sended to Client, as a Signal of a noise produced by a Sound Bait thrown by a Player.
 *
...
public class ServerToPlayer_GameProgressSoundBaitFeedbackPacket {

    //Private final encodable data to store in this Packet
    private final int soundBaitDistanceToSeeker;

    //Public methods

    public ServerToPlayer_GameProgressSoundBaitFeedbackPacket(int soundBaitDistanceToSeeker){
        ...
        this.soundBaitDistanceToSeeker = soundBaitDistanceToSeeker;
    }

    public ServerToPlayer_GameProgressSoundBaitFeedbackPacket(FriendlyByteBuf decodeBuffer){
    ...
    public void Encode(FriendlyByteBuf encodeBuffer){
        ...
        encodeBuffer.writeInt(this.soundBaitDistanceToSeeker);
    }
    ...
    public void Handle(Supplier<NetworkEvent.Context> contextSupplier){
        ...
        context.enqueueWork(() -> {
            //Send a signal to render the Sound Bait Feedback, informing the time in ms of this Triggering
            OnRenderGui.progress_soundBaitFeedbackLastTriggerTimeMs = System.currentTimeMillis();
            OnRenderGui.progress_soundBaitFeedbackDistanceToSeeker = soundBaitDistanceToSeeker;
