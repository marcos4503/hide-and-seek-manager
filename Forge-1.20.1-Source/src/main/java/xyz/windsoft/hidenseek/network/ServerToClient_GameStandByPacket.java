 ...
 * - This packet is created by the Server and sended to Client, as a Signal of the stage "StandBy".
 *
...
public class ServerToClient_GameStandByPacket {
    ...
    public ServerToClient_GameStandByPacket(String welcomeMessage){
    ...
    public ServerToClient_GameStandByPacket(FriendlyByteBuf decodeBuffer){
    ...
    public void Encode(FriendlyByteBuf encodeBuffer){
        ...
        encodeBuffer.writeUtf(this.welcomeMessage);
    }
    ...
    public void Handle(Supplier<NetworkEvent.Context> contextSupplier){
        ...
        context.enqueueWork(() -> {
            //Change the UI to stage of "StandBy"
            OnRenderGui.currentGui = OnRenderGui.GUI.StandBy;
            OnRenderGui.standBy_welcomeMsg = welcomeMessage;
