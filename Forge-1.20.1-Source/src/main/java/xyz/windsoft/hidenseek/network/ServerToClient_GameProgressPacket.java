 ...
 * - This packet is created by the Server and sended to Client, as a Signal of the stage "Progress".
 *
...
public class ServerToClient_GameProgressPacket {
    ...
    public ServerToClient_GameProgressPacket(){
    ...
    public ServerToClient_GameProgressPacket(FriendlyByteBuf decodeBuffer){
    ...
    public void Handle(Supplier<NetworkEvent.Context> contextSupplier){
        ...
        context.enqueueWork(() -> {
            //Change the UI to stage of "Progress"
            OnRenderGui.currentGui = OnRenderGui.GUI.Progress;
