 ...
 * - This packet is created by the Server and sended to Client, as a Signal of sound of Hidder camping at the Totem.
 *
...
public class ServerToClient_GameCountCampPacket {
    ...
    public ServerToClient_GameCountCampPacket(){
    ...
    public ServerToClient_GameCountCampPacket(FriendlyByteBuf decodeBuffer){
    ...
    public void Handle(Supplier<NetworkEvent.Context> contextSupplier){
        ...
        context.enqueueWork(() -> {
            ...
            //Play the sound of alert of camping...
            if (minecraftInstance.level != null)
                minecraftInstance.getSoundManager().play(SimpleSoundInstance.forUI(SoundEvents.ELDER_GUARDIAN_CURSE, 2.0f, 1.0f));
