 ...
 * - This packet is created by the Server and sended to Client, as a Signal of the stage "WaitingPlayers".
 *
...
public class ServerToClient_GameWaitingPlayersPacket {
    ...
    public ServerToClient_GameWaitingPlayersPacket(String waitingMessage){
    ...
    public ServerToClient_GameWaitingPlayersPacket(FriendlyByteBuf decodeBuffer){
    ...
    public void Encode(FriendlyByteBuf encodeBuffer){
        ...
        encodeBuffer.writeUtf(this.waitingMessage);
    }
    ...
    public void Handle(Supplier<NetworkEvent.Context> contextSupplier){
        ...
        context.enqueueWork(() -> {
            //Change the UI to stage of "WaitingPlayers"
            OnRenderGui.currentGui = OnRenderGui.GUI.WaitingPlayers;
            OnRenderGui.waitingPlayers_waitingMsg = waitingMessage;
