...
/*
 * This class creates the custom behavior for the item "Zero Gravity"
 *
...
public class ZeroGravity extends Item {

    //Public methods

    public ZeroGravity(Item.Properties pProperties) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        int ITEM_ADRENALINE_COST = Config.hidderZeroGravityAdrenalineCost;
        int ITEM_COOLDOWN_SECONDS = Config.hidderZeroGravityCooldown;

        //Add a base description
        tooltip.add(Component.translatable("tooltip.hidenseek.zero_gravity.desc").withStyle(ChatFormatting.BLUE));
        ...
        if (Screen.hasShiftDown() == true){
            tooltip.add(Component.translatable("tooltip.hidenseek.general.zero_gravity_levitation_duration").withStyle(ChatFormatting.GRAY)
                    .append(Component.literal(": ").withStyle(ChatFormatting.GRAY))
                    .append(Component.literal("60" + " ").withStyle(ChatFormatting.DARK_GRAY))
                    .append(Component.translatable("tooltip.hidenseek.general.seconds_abr").withStyle(ChatFormatting.DARK_GRAY)));
            tooltip.add(Component.translatable("tooltip.hidenseek.general.zero_gravity_slow_fall_duration").withStyle(ChatFormatting.GRAY)
                    .append(Component.literal(": ").withStyle(ChatFormatting.GRAY))
                    .append(Component.literal("80" + " ").withStyle(ChatFormatting.DARK_GRAY))
                    .append(Component.translatable("tooltip.hidenseek.general.seconds_abr").withStyle(ChatFormatting.DARK_GRAY)));
        }
            ...
            if (serverPlayer != null){
                ...
                if (playerPersistentNbt.contains("adrenalinePoints") == true){
                    ...
                    if (currentAdrenalinePoints >= ITEM_ADRENALINE_COST){
                        //Add the effect of levitation and slow fall for the Player
                        serverPlayer.addEffect(new MobEffectInstance(MobEffects.LEVITATION, 1200, 1, false, false));
                        serverPlayer.addEffect(new MobEffectInstance(MobEffects.SLOW_FALLING, 1600, 9, false, false));
                        //Play the sound of activation
                        serverPlayer.level().playSound(null, serverPlayer.blockPosition(), SoundEvents.ALLAY_AMBIENT_WITHOUT_ITEM, SoundSource.PLAYERS, 0.5f, 1.0f);
